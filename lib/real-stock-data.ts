...
export const TOP_STOCKS = {
    ...
    KOSDAQ: [
        ...
        { symbol: '068240', name: '다원시스' } // Replaced unknown ones
    ],
    SP500: [
        { symbol: 'AAPL', name: '애플' },
